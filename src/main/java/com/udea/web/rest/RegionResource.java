...
/**
 * REST controller for managing {@link com.udea.domain.Region}.
 */
@RestController
...
public class RegionResource {
    ...
    public List<Region> getAllRegions(@RequestParam(name = "filter", required = false) String filter) {
        if ("pais-is-null".equals(filter)) {
            LOG.debug("REST request to get all Regions where pais is null");
            return regionService.findAllWherePaisIsNull();
        }
