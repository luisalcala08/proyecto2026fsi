...
import { deleteEntity, getEntity } from './trabajo.reducer';

export const TrabajoDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/trabajo${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="proyecto2026App.trabajo.delete.question">
        <Translate contentKey="proyecto2026App.trabajo.delete.question" interpolate={{ id: trabajoEntity.id }}>
