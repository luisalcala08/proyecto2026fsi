...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './contrato.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRATO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTRATO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTRATO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONTRATO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTRATO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTRATO actions', async () => {
      const arg = 42666;
