  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="proyecto2026App.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="proyecto2026App.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('proyecto2026App.region.nombreRegion')}
                id="region-nombreRegion"
                name="nombreRegion"
                data-cy="nombreRegion"
                type="text"
              />
