    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departamentoDetailsHeading">
          <Translate contentKey="proyecto2026App.departamento.detail.title">Departamento</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="proyecto2026App.departamento.direccion">Direccion</Translate>
          </dt>
